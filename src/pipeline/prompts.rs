...
/// Build the extraction prompt for a batch of screenshots
pub fn build_extraction_prompt() -> &'static str {
    r#"
...
/// Build the rolling context synthesis prompt
pub fn build_rolling_prompt() -> &'static str {
    "Synthesize the last 30 minutes of activity into a rolling context."
}

/// Build the hourly digest synthesis prompt
pub fn build_hourly_prompt() -> &'static str {
    "Synthesize the last hour of activity into an hourly digest."
}

/// Build the daily summary synthesis prompt
pub fn build_daily_prompt() -> &'static str {
    "Synthesize the day's activity into a daily summary."
}
