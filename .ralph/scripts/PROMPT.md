...
1. Read the PRD at `.ralph/prd.json` (read-only — do NOT edit this file)
...
**Do NOT edit `.ralph/prd.json`.** The orchestration loop marks stories as complete automatically based on your git commits.
...
After completing steps 1–9 above for a single story:
...
This is not a suggestion. This is a hard constraint. One story. One commit. Then stop.
